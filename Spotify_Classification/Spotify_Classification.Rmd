...
Loudness and energy possess the highest positive correlation (0.81), therefore one must go in order to avoid prediction bias. Since `energy` is much more evenly distributed compared to `loudness`, the latter will be dropped from the final version of the full data frame.
...
```{r "kNN Model Performance", eval=FALSE}
...
```{r "Feature Performance", eval=FALSE}
