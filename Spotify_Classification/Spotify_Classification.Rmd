...
Based on the density plots above, `duration_min`, `instrumentalness`, `liveness`, `loudness`, `popularity`, and `speechiness` require normalization to ensure a well distributed dataset.
