...
- More data, builds on encoding, to have more rows with less labels in our response variable (variable to predict), thus less memory usage and faster run time.
- Utilize variable importance to reduce number of irrelevant predictors.